...
from packages.aws_neptune.loader_get_status_request import LoaderGetStatusRequest
from . import loader_load_timeout, loader_get_status_timeout


def send_check_loaded_request(
        ekg_sparql_loader_endpoint: object,
        loader_get_status_request: LoaderGetStatusRequest
) -> object:
    ...
    try:
        logging.info(f"Posting check load request, timeout={loader_load_timeout}")
        response = requests.get(
            ekg_sparql_loader_endpoint,
            params=loader_get_status_request,
            headers=headers,
            timeout=loader_get_status_timeout
        )
